 ...
 */
public class TenDollar extends AppCompatActivity{
    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ten_dollar);
        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbar);
        toolbar.setTitle("Back");
        setSupportActionBar(toolbar);

        TextView view_title = (TextView) findViewById(R.id.toolbar_title);
        view_title.setText("$10");
        ...
        tablayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    case 1:
                        intent = new Intent(TenDollar.this, HomePage.class);
                        bundle = new Bundle();
            ...
            public void onTabReselected(TabLayout.Tab tab) {
                Intent intent = new Intent(TenDollar.this, HomePage.class);
                startActivity(intent);
            }
